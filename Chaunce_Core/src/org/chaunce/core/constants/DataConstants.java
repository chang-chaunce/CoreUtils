package org.chaunce.core.constants;

/**
 * @ClassName: DataConstants
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author changqingquan
 * @date 2014-7-4 上午9:58:28
 * 
 */
public interface DataConstants {
	...
	public static final short UNSIGNED_BYTE_MAX_VALUE = (short) Byte.MAX_VALUE
			- (short) Byte.MIN_VALUE;
	public static final int UNSIGNED_SHORT_MAX_VALUE = (int) Short.MAX_VALUE
			- (int) Short.MIN_VALUE;
	public static final long UNSIGNED_INT_MAX_VALUE = (long) Integer.MAX_VALUE
