...
public class Debug {
	...
	// Constants
	// ===========================================================
	public static final String DEBUGTAG = "Chaunce";
	...
	public static void log(final DebugLevel pDebugLevel, final String pTag,
	...
	public static void log(final DebugLevel pDebugLevel, final String pTag,
			final String pMessage, final Throwable pThrowable) {
		switch (pDebugLevel) {
		case NONE:
			return;
		case VERBOSE:
	...
	public static void vUser(final String pMessage, final Throwable pThrowable,
	...
	public static void vUser(final String pTag, final String pMessage,
			final String pDebugUser) {
		if (Debug.sDebugUser.equals(pDebugUser)) {
			Debug.v(pTag, pMessage);
		}
	...
	public static void vUser(final String pTag, final String pMessage,
			final Throwable pThrowable, final String pDebugUser) {
		if (Debug.sDebugUser.equals(pDebugUser)) {
			Debug.v(pTag, pMessage, pThrowable);
		}
	}
	...
	public static void dUser(final String pMessage, final Throwable pThrowable,
			final String pDebugUser) {
		if (Debug.sDebugUser.equals(pDebugUser)) {
			Debug.d(pMessage, pThrowable);
		}
	...
	public static void dUser(final String pTag, final String pMessage,
			final String pDebugUser) {
		if (Debug.sDebugUser.equals(pDebugUser)) {
			Debug.d(pTag, pMessage);
		}
	...
	public static void iUser(final String pMessage, final Throwable pThrowable,
			final String pDebugUser) {
		if (Debug.sDebugUser.equals(pDebugUser)) {
			Debug.i(pMessage, pThrowable);
		}
	...
	public static void iUser(final String pTag, final String pMessage,
			final String pDebugUser) {
		if (Debug.sDebugUser.equals(pDebugUser)) {
			Debug.i(pTag, pMessage);
		}
	...
	public static void wUser(final String pMessage, final Throwable pThrowable,
			final String pDebugUser) {
		if (Debug.sDebugUser.equals(pDebugUser)) {
			Debug.w(pMessage, pThrowable);
		}
	...
	public static void wUser(final String pTag, final String pMessage,
			final String pDebugUser) {
		if (Debug.sDebugUser.equals(pDebugUser)) {
			Debug.w(pTag, pMessage);
		}
	...
	public static void eUser(final String pMessage, final Throwable pThrowable,
			final String pDebugUser) {
		if (Debug.sDebugUser.equals(pDebugUser)) {
			Debug.e(pMessage, pThrowable);
		}
	...
	public static void eUser(final String pTag, final String pMessage,
			final String pDebugUser) {
		if (Debug.sDebugUser.equals(pDebugUser)) {
			Debug.e(pTag, pMessage);
		}
